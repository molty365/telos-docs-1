...
Each privacy pool has its own relayer instance:

| Pool | Pool ID | Relayer URL |
|------|---------|-------------|
| WTLOS | 40001 | `https://dsw2020napxes.cloudfront.net/` |
| USDC.e | 40002 | `https://d39zrx7k37xhn.cloudfront.net/` |

All REST API paths below are relative to these base URLs.
...
```bash
# Get WTLOS pool state
curl https://dsw2020napxes.cloudfront.net/info

# Get USDC.e relayer fee
curl https://d39zrx7k37xhn.cloudfront.net/fee
```
